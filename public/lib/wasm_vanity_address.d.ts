declare namespace wasm_bindgen {
	...
	*/
	...
	/**
	*/
	export class SolKeypair {
	  free(): void;
	/**
	* @param {string} s
	* @returns {SolKeypair}
	*/
	  static generate(s: string): SolKeypair;
	/**
	* @returns {number}
	*/
	  public_key(): number;
...
declare interface InitOutput {
  ...
  readonly __wbg_solkeypair_free: (a: number) => void;
  readonly solkeypair_generate: (a: number, b: number) => number;
  readonly solkeypair_public_key: (a: number) => number;
  readonly solkeypair_secret_key: (a: number) => number;
