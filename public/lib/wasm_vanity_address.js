...
class SolKeypair {
    ...
    static __wrap(ptr) {
        const obj = Object.create(SolKeypair.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_solkeypair_free(ptr);
    }
    /**
    * @param {string} s
    * @returns {SolKeypair}
    */
    static generate(s) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.solkeypair_generate(ptr0, len0);
        return SolKeypair.__wrap(ret);
    }
    /**
    * @returns {number}
    */
    public_key() {
        const ret = wasm.solkeypair_public_key(this.ptr);
        return ret;
    }
    /**
    * @returns {number}
    */
    secret_key() {
        const ret = wasm.solkeypair_secret_key(this.ptr);
        return ret;
    }
}
__exports.SolKeypair = SolKeypair;
