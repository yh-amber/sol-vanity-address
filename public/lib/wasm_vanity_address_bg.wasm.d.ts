...
export function __wbg_solkeypair_free(a: number): void;
export function solkeypair_generate(a: number, b: number): number;
export function solkeypair_public_key(a: number): number;
export function solkeypair_secret_key(a: number): number;
